 ...
 */
#define MAGMADNN_DNNL_ERROR(_errcode) ::magmadnn::DnnlError(__FILE__, __LINE__, __func__, _errcode)
 ...
 * @param errcode  The error code returned from a CUDA runtime API routine.
 */
#define MAGMADNN_CUDA_ERROR(_errcode) ::magmadnn::CudaError(__FILE__, __LINE__, __func__, _errcode)
 ...
 */
#define MAGMADNN_CUBLAS_ERROR(_errcode) ::magmadnn::CublasError(__FILE__, __LINE__, __func__, _errcode)
 ...
 * @param errcode  The error code returned from the cuBLAS routine.
 */
#define MAGMADNN_CUDNN_ERROR(_errcode) ::magmadnn::CudnnError(__FILE__, __LINE__, __func__, _errcode)
