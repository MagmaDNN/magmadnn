...
magmadnn::magmadnn_error_t read_cifar100(
   ...
   *data = new magmadnn::Tensor<float>({n_images, n_channels, image_height, image_width}, {magmadnn::NONE, {}}, magmadnn::HOST);
...
magmadnn::magmadnn_error_t load_cifar100(
   ...
   return read_cifar100(
          cifar_root + "/train.bin", data, labels, n_images,
          image_width, image_height, n_channels, n_classes,
          n_super_classes/*, normalize*/);
}
...
magmadnn::magmadnn_error_t read_cifar10(
   ...
   *data = new magmadnn::Tensor<float>(
         {n_images, n_channels, image_height, image_width},
         {magmadnn::NONE, {}}, magmadnn::HOST);
   *labels = new magmadnn::Tensor<float>(
         {n_images, n_classes},
         {magmadnn::ZERO, {}}, magmadnn::HOST);
...
magmadnn::magmadnn_error_t load_cifar10_batch(
   ...
   return read_cifar10(
         cifar_root + "/data_batch_" + std::to_string(batch_idx) + ".bin",
         data, labels, n_images,
