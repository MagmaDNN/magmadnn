...
template void sgd_momentum_cpu<float>(float learning_rate, float momentum, Tensor<float> *prev, Tensor<float> *grad,
                                      std::vector<int> *idxs, Tensor<float> *out);
template void sgd_momentum_cpu<double>(double learning_rate, double momentum, Tensor<double> *prev,
                                       Tensor<double> *grad, std::vector<int> *idxs, Tensor<double> *out);
...
template void sgd_momentum_cpu(int learning_rate, int momentum, Tensor<int> *prev, Tensor<int> *grad, Tensor<int> *out);
template void sgd_momentum_cpu(float learning_rate, float momentum, Tensor<float> *prev, Tensor<float> *grad,
                               Tensor<float> *out);
template void sgd_momentum_cpu(double learning_rate, double momentum, Tensor<double> *prev, Tensor<double> *grad,
                               Tensor<double> *out);
