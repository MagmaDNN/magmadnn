...
template magmadnn_error_t gradientdescent_update_internal_device(Tensor<int> *var, Tensor<int> *grad, int learning_rate);
template magmadnn_error_t gradientdescent_update_internal_device(Tensor<float> *var, Tensor<float> *grad, float learning_rate);
template magmadnn_error_t gradientdescent_update_internal_device(Tensor<double> *var, Tensor<double> *grad, double learning_rate);
