...
template magmadnn_error_t get_grad_table(const std::vector<Operation<int> *> &vars, Operation<int> *graph,
                                         GradTable<int> &table);
template magmadnn_error_t get_grad_table(const std::vector<Operation<float> *> &vars, Operation<float> *graph,
                                         GradTable<float> &table);
template magmadnn_error_t get_grad_table(const std::vector<Operation<double> *> &vars, Operation<double> *graph,
                                         GradTable<double> &table);
...
template magmadnn_error_t build_grad(op::Operation<int> *var, op::Operation<int> *graph, op::GradTable<int> &table,
                                     Tensor<int> **grad);
template magmadnn_error_t build_grad(op::Operation<float> *var, op::Operation<float> *graph,
                                     op::GradTable<float> &table, Tensor<float> **grad);
template magmadnn_error_t build_grad(op::Operation<double> *var, op::Operation<double> *graph,
                                     op::GradTable<double> &table, Tensor<double> **grad);
